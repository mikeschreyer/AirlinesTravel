 ...
 * @var \App\Model\Entity\Color[]|\Cake\Collection\CollectionInterface $color
 */
?>
...
<div class="color index large-9 medium-8 columns content">
    <h3><?= __('Color') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('modele_id') ?></th>
